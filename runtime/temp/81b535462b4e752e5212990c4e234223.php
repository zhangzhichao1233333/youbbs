<?php /*a:1:{s:71:"/users/sftc/work/code/youbbs/application/index/view/index/nodepage.html";i:1664340406;}*/ ?>
<?php
...
if($page<0){
    ...
    if($page>$taltol_page){
        header('location: /new/nodes/'.$cid.'-'.$taltol_page);
        exit;
    }
}
